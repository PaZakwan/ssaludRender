            ...
            detallado = {
              detalle_entregas: {
                $push: {
                  ...
                  oSocial: "$oSocial",
                  oSocialNumero: "$oSocialNumero",
                  fecha_prescripcion: {
                    $dateToString: {format: "%Y-%m-%d", date: "$fecha_prescripcion"},
                  },
                  profesional_MP: "$profesional_MP",
                  profesional_MN: "$profesional_MN",
        ...
        if (modelos.entr.ex && !modelos.entr.nd) {
          entregasDB
            ...
            .addFields({
              ...
              oSocialNumero: {$ifNull: ["$detalle_entregas.oSocialNumero", "$noRetornaNada"]},
              fecha_prescripcion: {
                $ifNull: ["$detalle_entregas.fecha_prescripcion", "$noRetornaNada"],
              },
              profesional_MP: {$ifNull: ["$detalle_entregas.profesional_MP", "$noRetornaNada"]},
              profesional_MN: {$ifNull: ["$detalle_entregas.profesional_MN", "$noRetornaNada"]},
              accion_terapeutica: {
                $ifNull: ["$detalle_entregas.accion_terapeutica", "$noRetornaNada"],
              },
