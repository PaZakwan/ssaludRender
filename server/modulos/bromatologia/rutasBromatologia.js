...
const {verificaToken, verificaBromatologia} = require("../../middlewares/autenticacion");
...
// ============================
app.get("/bromatologia", [verificaToken, verificaBromatologia], async (req, res) => {
  try {
...
// ============================
app.get("/bromatologia/buscar/:id", [verificaToken, verificaBromatologia], async (req, res) => {
  try {
    let analisisDB = null;
...
// ===========================
app.get("/bromatologia/buscar", [verificaToken, verificaBromatologia], async (req, res) => {
  try {
...
// Crear Analisis
// ============================
app.post("/bromatologia", [verificaToken, verificaBromatologia], async (req, res) => {
  try {
    if (req.usuario.bromatologia < 2) {
...
// ============================
app.put("/bromatologia/:id", [verificaToken, verificaBromatologia], async (req, res) => {
  try {
    if (req.usuario.bromatologia < 2) {
      return errorMessage(res, {message: "Acceso Denegado."}, 401);
    }
...
// ============================
app.put("/bromatologia/validar/:id", [verificaToken, verificaBromatologia], async (req, res) => {
  try {
    if (req.usuario.bromatologia < 3) {
      return errorMessage(res, {message: "Acceso Denegado."}, 401);
    }
...
// ============================
app.delete("/bromatologia/:id", [verificaToken, verificaBromatologia], async (req, res) => {
  try {
    if (req.usuario.bromatologia < 3) {
      return errorMessage(res, {message: "Acceso Denegado."}, 401);
    }
